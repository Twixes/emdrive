...
const M1: u128 = 0x55555555555555555555555555555555; // 01010101...
const M2: u128 = 0x33333333333333333333333333333333; // 00110011...
const M4: u128 = 0x0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f; // 00001111...
const M8: u128 = 0x00ff00ff00ff00ff00ff00ff00ff00ff; // and so on
...
pub type Element = u128;
pub type Distance = u8;

pub fn weight(x: Element) -> Distance {
...
pub fn distance(x: Element, y: Element) -> Distance {
    weight(x ^ y)
}
...
mod tests {
    ...
    fn hamming_distance_is_calculated_correctly() {
        ...
        assert_eq!(distance(0xf000000000000000ffffffffffffffff, 0x0000000000000000fff0ffffffffffff), 8);
